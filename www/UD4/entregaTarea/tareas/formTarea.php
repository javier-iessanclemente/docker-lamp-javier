...
<div class="mb-3">
    ...
    <select class="form-select" id="id_usuario" name="id_usuario" required>
        <option value="" <?php echo (isset($id_usuario) || !esAdmin()) ? '' : 'selected' ?> disabled>Seleccione el usuario</option>
        <?php
            ...
            if(esAdmin()) {
                ...
                $usuarios= [buscaUsuario($_SESSION["usuario"]["id"])];
            }
            foreach ($usuarios as $usuario) { ?>
                <option value="<?php echo ($usuario['id']); ?>" <?php echo ((isset($id_usuario) && $id_usuario == $usuario['id']) || !esAdmin()) ? 'selected' : '' ?>>
